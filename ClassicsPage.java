...
private JPanel createPizzaButtonsPanel(String firstName, String lastName) {
    ...
    String[] pizzaImages = {"C:\\Users\\ebend\\OneDrive\\Desktop\\VsCode Projects\\TheUrbanSlice\\gui\\images\\pepperoni.png", "C:\\Users\\ebend\\OneDrive\\Desktop\\VsCode Projects\\TheUrbanSlice\\gui\\images\\cheese.png", "C:\\Users\\ebend\\OneDrive\\Desktop\\VsCode Projects\\TheUrbanSlice\\gui\\images\\images.jpg", "C:\\Users\\ebend\\OneDrive\\Desktop\\VsCode Projects\\TheUrbanSlice\\gui\\images\\5ff33d7df72e71d8755784135a6e6edd.jpg", "C:\\Users\\ebend\\OneDrive\\Desktop\\VsCode Projects\\TheUrbanSlice\\gui\\images\\DSC_0905-min.png"};
    ...
    for (int i = 0; i < pizzaTypes.length; i++) {
        ...
        JPanel sizeAndOrderPanel = createSizeAndOrderPanel(pizzaTypes[i]);
...
private JButton createPizzaButton(String firstName, String lastName, String pizzaType, String imagePath) {
    ...
    pizzaButton.setPreferredSize(new Dimension(160, 160)); // Adjusted size
    pizzaButton.setBorder(BorderFactory.createEmptyBorder());

    pizzaButton.addActionListener(e -> {
        handlePizzaButtonClick(firstName, lastName, pizzaType);
    });
...
private JPanel createSizeAndOrderPanel(String pizzaType) {
    ...
    sizeButton.addActionListener(e -> handleSizeButtonClick(pizzaType, sizes));
...
private void handleSizeButtonClick(String pizzaType, String[] sizes) {
