...
public class OrderConfirmationPage extends JFrame {
    ...
    public OrderConfirmationPage(String firstName, String lastName, List<CartItem> orderedItems) {
...
private JPanel createContentPanel() {
    ...
    public static void main(String[] args) {
        ...
        List<CartItem> orderedItems = new java.util.ArrayList<>();
        orderedItems.add(new CartItem("Pizza", "path/to/pizza-image.jpg", 2, 12.99));
        orderedItems.add(new CartItem("Brownie", "path/to/brownie-image.jpg", 1, 5.99));
