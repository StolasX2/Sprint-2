...
public class BeveragesPage extends JFrame {
    ...
    private final double[] smallPrices = {1.99, 1.99, 1.99, 1.99, 1.99};
    private final double[] mediumPrices = {2.99, 2.99, 2.99, 2.99, 2.99};
    private final double[] largePrices = {3.99, 3.99, 3.99, 3.99, 3.99};
    private final double[] xlPrices = {4.99, 4.99, 4.99, 4.99, 4.99};
