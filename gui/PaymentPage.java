...
private JPanel createContentPanel() {
    ...
    private JPanel createPaymentPanel() {
        ...
        // Balance Due
        double orderTotal = cartPage.calculateTotal(); // Get order total from cart page
    ...
    private JPanel createBalanceAndOptionsPanel() {
        ...
        orderDetailsPanel.setLayout(new GridLayout(cartPage.getCartItems().size(), 1));

        for (CartItem item : cartPage.getCartItems()) {
            JLabel itemLabel = new JLabel(item.toString());
            orderDetailsPanel.add(itemLabel);
        }

        JLabel totalLabel = new JLabel("Total: $" + cartPage.calculateTotal());
    ...
    List<CartItem> cartItems = cartPage.getCartItems(); // Get cart items
    ...
    private void showCardPopup() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            handlePaymentButtonClick(cartPage.calculateTotal(), true, false, false);
        }
    }
    ...
    private void showCheckPopup() {
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            handlePaymentButtonClick(cartPage.calculateTotal(), false, false, true);
        }
    }
   ...
   private double calculateBalanceDue() {
    return cartPage.calculateTotal(); // Assuming you have a method to calculate the total in CartPage
}
